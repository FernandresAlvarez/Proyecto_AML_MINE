...
class ModelController:
    ...
    def __init__(self):
        ...
        self.IsolationForest_model_path = osp.join(self.model_path, "df4IsolationForest.joblib")
        ...
        #Cargar los modelos
        self.IsolationForest_model = joblib.load(self.IsolationForest_model_path)
